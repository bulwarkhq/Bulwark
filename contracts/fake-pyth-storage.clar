;; Test-only IMPOSTOR storage: implements the same trait, returns whatever price it is given.
;; Used to prove the guard refuses storage contracts it was not configured with.
